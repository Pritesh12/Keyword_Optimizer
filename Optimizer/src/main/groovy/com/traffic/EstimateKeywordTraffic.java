...
// limitations under the License.ppp
...
import com.google.api.ads.adwords.axis.v201609.o.AdGroupEstimateRequest;
import com.google.api.ads.adwords.axis.v201609.o.CampaignEstimate;
import com.google.api.ads.adwords.axis.v201609.o.CampaignEstimateRequest;
import com.google.api.ads.adwords.axis.v201609.o.KeywordEstimate;
import com.google.api.ads.adwords.axis.v201609.o.KeywordEstimateRequest;
import com.google.api.ads.adwords.axis.v201609.o.PlatformCampaignEstimate;
import com.google.api.ads.adwords.axis.v201609.o.StatsEstimate;
import com.google.api.ads.adwords.axis.v201609.o.TrafficEstimatorResult;
import com.google.api.ads.adwords.axis.v201609.o.TrafficEstimatorSelector;
import com.google.api.ads.adwords.axis.v201609.o.TrafficEstimatorServiceInterface;
...
public static void main(String[] args) throws Exception {
  ...
  EstimateKeywordTraffic estimatetesting = new EstimateKeywordTraffic();
  ...
  public static ArrayList<BeanDTO> runExample(
      AdWordsServices adWordsServices, AdWordsSession session,String userinput) throws Exception {
    // Get the TrafficEstimatorService.
      /*com.traffic.EstimateKeywordTraffic ekt = new com.traffic.EstimateKeywordTraffic();
	  String str = ekt.getInput();
*/
   ...
   /* Keyword marsCruiseKeyword = new Keyword();
    marsCruiseKeyword.setText(userinput);
...
//  System.out.println("hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
    GetKeywordIdeas gt = new GetKeywordIdeas();
    gt.runExample(adWordsServices, session, userinput);

    System.out.println("cominnnnnnnnnnn");
    //GetBudgetSuggestion bs=new GetBudgetSuggestion();
    // bs.runExample(adWordsServices, session, str);
    ...
    if (result != null
      ...
      for (int i = 0; i < keywordEstimates.length; i++) {
        ...
        BeanDTO obj = displayMeanEstimates(keywordMessage, keywordEstimate.getMin(), keywordEstimate.getMax());
   ...
   */
  private static BeanDTO displayMeanEstimates(String message, StatsEstimate minEstimate,
    ...
    beandto.setMeanAverageCpc(meanAverageCpc);
    beandto.setMeanAveragePosition(meanAveragePosition);
    beandto.setMeanClicks(meanClicks);
    beandto.setMeanTotalCost(meanTotalCost);

    System.out.println("----------------meanaveragecpc-----------------");
    ...
    System.out.println("**********estimate******************"+beandto);
    return beandto;

  }
 /* Double testEstimate(Double meanAverageCPC, Double meanAveragePosition, Double meanClicks, Double meanTotalCost){
    ArrayList<Double> et = new ArrayList<>();
    Double d1 = meanAverageCPC;
    Double d2 = meanAveragePosition;
    Double d3 = meanClicks;
    Double d4 = meanTotalCost;
